...
class DoubleConv(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv = nn.Sequential( # e un CONTAINER SECVENTIAL, ce va contine straturi
            ...
            nn.LeakyReLU(negative_slope=0.01, inplace=True), #! DE AI CI AR PUTEA VENI O EROARE. Il pun pentru a elibera o parte din memorie. Asta inseamna ca nu se va rea un spatiu aditional pentru rezultatul BatchNorm, ci se va trece direct prin ReLU
...
class UNET_semantic_brats_2D_v3_COPIE(nn.Module):
    def __init__(self, in_channels=4, out_channels=3, features = [64, 128, 256, ]):
        ...
        '''
        super(UNET_semantic_brats_2D_v3_COPIE, self).__init__()
