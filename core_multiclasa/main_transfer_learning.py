...
from networks_folder_semantic.unet_semantic_brats_2D_v3_transferLR_1 import unfreeze_whole_network
from networks_folder_semantic.unet_semantic_brats_2D_v3_transferLR_1 import get_custom_modified_network
...
def main():
    ...
    #LOAD_PATH = r'E:\an_4_LICENTA\Workspace\Scripturi\core_semantic\models_test_semantic\model47.pth'
    LOAD_PATH = r'E:\an_4_LICENTA\Workspace\modele_salvate_semantica\model10.pth'
    ...
    #AL_DATA_PATH = r'E:\an_4_LICENTA\Workspace\Dataset\Optimization_Dataset_gibbsringingartefactremoved\gibbsringingartefactremoval_PNG_Val_Dataset'
    VAL_DATA_PATH = r'E:\an_4_LICENTA\Workspace\Dataset\Full_Dataset\gibremoved_PNG_Val_Dataset'
    ...
    nr_epochs = 30 # * de aici se schimba nr de epoci
    #nr_epochs = 100
    ...
    # 1. Test
    # Etapa 1. Freeze. 
    # Obs: o sa dureze foarte putin, pentru ca eroarea nu s emai propaga asa deparete
    ...
    # Custom freeze
    #net = UNET_semantic_brats_2D_v3_COPIE(in_channels=4, out_channels=1, features = [32, 64, 128, 256]) # instantiere retea. Initial e cu 1 canal, iar asta se schimba in get_modified_network
    #net = get_custom_modified_network(net, mode='last_2_layers', verboise=False) # se incarca parametrii
    
    # Etapa 2. Unfreeze all network
    TRLR_LOAD_PATH = r'E:\an_4_LICENTA\Workspace\Scripturi\core_semantic\models_test_semantic\model10.pth'
    ...
    net = unfreeze_whole_network(net)
    ...
    for g in optimizer.param_groups:
        g['lr'] = 0.0001 # se seteaza lr la 10^(-5)
