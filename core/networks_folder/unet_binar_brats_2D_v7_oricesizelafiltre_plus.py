...
class Shrinker_conv(nn.Module):
    def __init__(self, feature):
        ...
        self.conv = nn.Sequential(
            ...
            nn.Conv2d(feature, feature, kernel_size=2, stride=2),
...
class Concat_mechanism(nn.Module): # cu rol de reducere la juamtate a feature map-ului
    def __init__(self, feature):
        ...
        self.reduce_no_features = nn.Sequential(
            nn.Conv2d(feature, feature, kernel_size=1, stride=1, padding = 'same'), # pointwise
            nn.BatchNorm2d(feature),
        )
    def forward(self, x):
...
class UNET_binar_brats_2D_v7_plus(nn.Module):
    def __init__(self, in_channels=4, out_channels=3, features = [64, 128, 256, ]):
        ...
        '''
        super(UNET_binar_brats_2D_v7_plus, self).__init__()
